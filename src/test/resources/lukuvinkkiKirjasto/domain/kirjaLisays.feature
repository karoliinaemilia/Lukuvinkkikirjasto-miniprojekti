Feature: Kayttaja voi lisata kirjan
  ...
  Scenario: kirjan lisays
    ...
    When kentat taytetaan tiedoilla "9789519854892","Testi", "testinen", "200","testi linkki" ,"Testi testinen", "2018"  ja painetaan lisaa
  ...
  Scenario: kirjaa ei voi lisata samalla ISBN:alla
    ...
    When kentat taytetaan tiedoilla "9780136019701","toinenTesti", "testinen2", "201","testi linkki2" ,"Testi testinennen", "2019"  ja painetaan lisaa
  ...
  Scenario: kirjan voi lisata ilman linkkia
    Given mennaan kirjojen alkusivulle
    When kentat taytetaan tiedoilla "9789511308799","Testi", "testinen", "200","" ,"Testi testinen", "2018"  ja painetaan lisaa
